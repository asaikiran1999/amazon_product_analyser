...
def main():
	...
	if t==1:
		...
		if st.button('analyse'):
			...
			for review in soup.find_all('div', class_='review-text-content'):reviews = reviews.get_text().strip()for i in range(0,len(reviews)):reviews_list.append(reviews[i].get_text())
